...
CREATE TABLE `tbl_dictionary` (
  ...
  `name` varchar(50) NOT NULL COMMENT 'Tên từ điiển',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Từ điển';
...
--
ALTER TABLE `tbl_dictionary`
  MODIFY `id` smallint(6) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Mã từ điển';COMMIT;
